<template>
    <div>
        ...
        <div v-if="loadingData && isEdit" class="text-center py-5"> <!-- ← loadingData -->
                ...
                <form @submit.prevent="submitForm">
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input v-model="form.operation_date" type="date" class="form-control"
                                :class="{ 'is-invalid': errors.operation_date }" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <select v-model="form.subcategory" class="form-select"
                                :class="{ 'is-invalid': errors.subcategory }" :disabled="!form.category" required>
                        ...
                        <div class="col-md-6">
                            ...
                            <input v-model.number="form.amount" type="number" step="0.01" min="0.01"
                                class="form-control" :class="{ 'is-invalid': errors.amount }" placeholder="0.00"
                                required>
